...
def load_coco(anno_file, xml_save_path):
    ...
    f = open('data/tiny_set/ImageSets/Main/val.txt','w')
    for imgId in tqdm(imgIds):
        ...
        for ann in anns:
            ...
            objs.append(obj)
        filename = save_anno_to_xml(filename, size, objs, xml_save_path)
        f.write(filename[:-1] + '\n')
    f.close()
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--data-dir', type=str, default='data/tiny_set/annotations/tiny_set_test.json', help='json path')
    parser.add_argument('-s', '--save-path', type=str, default='data/tiny_set/voc_format', help='xml save path')
